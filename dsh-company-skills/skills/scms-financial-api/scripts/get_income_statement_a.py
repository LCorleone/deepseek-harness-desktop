...
def get_income_statement_a(
    thscode: str, report_type: str = "年报", periods: int = 1
) -> list:
    """
    获取 A 股利润表
...
def main():
    ...
    result = get_income_statement_a(args.thscode, args.report_type, args.periods)
