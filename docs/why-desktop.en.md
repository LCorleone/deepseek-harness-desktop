...
- Compatibility, extended, and advanced presentation modes. Compatibility preserves the upstream client below an independent Desktop frame; extended uses the Desktop-owned layout/sidebar surface to host official occupants in an inverted L; advanced uses the same Desktop layout with internal captions. Desktop frames provide capability-gated native materials and drag regions.
