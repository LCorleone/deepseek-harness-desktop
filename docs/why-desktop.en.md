...
- Compatibility, extended, and advanced presentation modes. Compatibility preserves the upstream client below an independent Desktop frame; extended adds the sidebar to that frame's material layer to form the inverted L; advanced adds the Desktop-owned layout. Desktop frames provide capability-gated native materials and drag regions.
