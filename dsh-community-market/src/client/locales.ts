export const zh = {
  ...
  source: '来源',
  details: '插件详情',
  readOnly: '暂不支持在桌面端自动安装此插件。你仍可查看插件信息。',
  checkingInstallMethod: '正在确认可用的安装方式...',
  transientInstallHint: '这次失败看起来是网络波动等临时问题，重试通常可以解决。',
  desktopActionUnavailable: '当前环境不支持这个桌面操作。',
  restartError: '无法请求重启 DSH Desktop，请稍后手动重启。',
  restartExpired: '重启确认已过期（不影响刚才的操作）。现在手动重启即可生效。',
  ...
  updateAvailableBadge: '可更新 → {version}',
  uninstall: '卸载',
  disable: '禁用',
  enable: '启用',
  ...
  previewTimeoutError: '插件预览超时，无法确认结果。请刷新后重试。',
  ...
  executeTimeoutError: '操作超时，无法确认结果。请先刷新“已安装”后重试，避免重复操作。',
  plugin: '插件',
  package: 'npm 包',
  exactVersion: '精确版本',
  profile: '当前配置',
  ...
  updateBannerTitle: '插件有可用更新',
  updateBannerBody: '以下已安装插件有新版本。更新会直接安装新版本替换旧版本（无需先卸载），完成后需要重启一次。',
  updateAction: '更新',
  replacesVersion: '当前版本',
  confirmUpdateTitle: '确认更新插件',
  confirmUpdateBody: 'DSH Desktop 将直接安装新版本替换当前版本（无需先卸载），完成后需要重启一次。',
  confirmUpdate: '确认更新',
  updating: '正在更新...',
  ...
  operationRisk: '以错误方式安装插件，或者安装未经验证的插件，可能导致软件崩溃或异常。如有问题请联系插件开发者。',
  ...
  builtIn: '内置适配器',
  partner: '合作提供方',
  sourcePartnershipBefore: '除了添加符合接入格式的自定义来源，还可以查阅',
  sourcePartnershipGuide: '来源接入指南',
  selectSource: '选择此来源',
  selectedSource: '当前来源',
  add: '添加',
  remove: '移除来源',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  readOnly: 'This plugin cannot currently be installed automatically in Desktop. You can still review its details.',
  checkingInstallMethod: 'Checking available installation methods...',
  transientInstallHint: 'This failure looks temporary (for example a network hiccup); retrying usually resolves it.',
  ...
  restartExpired: 'The restart confirmation expired — the operation itself succeeded. Restart manually now to apply it.',
  ...
  install: 'Install',
  installedBadge: 'Installed {version}',
  updateAvailableBadge: 'Update available → {version}',
  uninstall: 'Uninstall',
  disable: 'Disable',
  enable: 'Enable',
  ...
  previewTimeoutError: 'The operation preview timed out before the result could be confirmed. Refresh and try again.',
  ...
  executeTimeoutError: 'The operation timed out before the result could be confirmed. Refresh Installed before trying again to avoid repeating the operation.',
  plugin: 'Plugin',
  package: 'npm package',
  ...
  updateBannerTitle: 'Plugin updates available',
  updateBannerBody: 'These installed plugins have newer versions. Updating installs the new version in place of the old one (no uninstall step) and needs one restart afterwards.',
  updateAction: 'Update',
  replacesVersion: 'Current version',
  confirmUpdateTitle: 'Confirm plugin update',
  confirmUpdateBody: 'DSH Desktop will install the new version in place of the current one (no uninstall step). One restart is needed afterwards.',
  ...
  operationRisk: 'Installing a plugin incorrectly, or installing an unverified plugin, may cause crashes or unexpected behavior. Contact the plugin developer if anything looks wrong.',
