...
- [ ] 编写测试
- [ ] 更新文档
- 背景：0.1.1 beta seq30 真机可用(company_skill_list + ppt-designer)；promote 走 cli.mjs promote→CI 签名→publish-local stable→棘轮31。非 b92 前置(分轨已解地板误判)。0.1.0 旧钉保留窗口内待 retire。
