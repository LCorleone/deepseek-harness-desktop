...
| @deepseek-ai/dsh-agent-tool-presentation | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-client-ui-primitives | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-client-ui-slots | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-headless | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-mcp-client | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-persona | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-schedule | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-terminal | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-terminal-bash | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-time-context | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-timeout | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tmux-context | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-token-meter | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tool-ask-user | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tool-bash | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tool-bash-persistent | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tool-call-timeout-policy | 0.1.1-rc.2 | MIT |
| @deepseek-ai/dsh-tool-cordis | 0.1.1-rc.2 | MIT |
...
| @deepseek-ai/dsh-tool-pwsh-persistent | 0.1.1-rc.2 | MIT |
