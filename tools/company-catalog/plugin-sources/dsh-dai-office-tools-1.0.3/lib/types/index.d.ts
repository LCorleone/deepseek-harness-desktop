/**
 * dsh-dai-office-tools host plugin.
 *
 * Registers nine model-facing tools on `ctx.tools`:
 *
 *   word_create / word_read / word_update
 *   excel_create / excel_read / excel_update
 *   ppt_create / ppt_read / ppt_update
 *
 ...
 * bytes, writes as UTF-8 text (generated packages and embedded SVG media are
 * ASCII-safe by construction). Every registration is wrapped in `ctx.effect` so Cordis
...
export declare const name = "dsh-dai-office-tools";
...
export interface Config {
    /** Register `ppt_create` / `ppt_read` / `ppt_update`. */
