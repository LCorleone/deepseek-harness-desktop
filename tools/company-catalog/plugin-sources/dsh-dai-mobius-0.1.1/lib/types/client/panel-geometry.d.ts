...
export declare const PANEL_LAYOUT_STORAGE_KEY = "dsh-mobius:activity-panel:v1";
export declare const PANEL_BADGE_OFFSET_STORAGE_KEY = "dsh-mobius:activity-badge-offset:v1";
...
/** Persistent drag offset applied to the collapsed badge (dx, dy from its dock). */
export interface BadgeOffset {
    readonly x: number;
    readonly y: number;
}
/** Read a persisted badge offset, rejecting out-of-range/corrupt values. */
export declare function parseBadgeOffset(value: string | null): BadgeOffset;
