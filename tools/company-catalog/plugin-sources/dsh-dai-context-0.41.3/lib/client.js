window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const DICT_ZH = {
			...
			"gran.turn": "轮次",
			"settings.title": "上下文",
			"settings.desc": "dsh-dai-context 插件中上下文面板的偏好设置",
		...
		const DICT_EN = {
			...
			"settings.desc": "Preferences for Context panel in dsh-dai-context plugin",
		...
		*/
		...
		function registerContextCommand(ctx, kit) {
			ctx.inject(["inputTriggers"], (ictx) => {
				...
				}), "dsh-dai-context: /context command");
			});
		}
		//#endregion
			...
			return function ContextBrowser(props) {
				...
				React.useEffect(() => {
					...
					fetchContent(missingSeq).then((node) => {
						...
						console.warn("dsh-dai-context: targeted history read failed", error);
				...
				React.useEffect(() => {
					...
					fetchHeader(headerSeq).then((content) => {
						...
						console.warn("dsh-dai-context: header content fetch failed", error);
		...
		*/
		...
		//#endregion
		// [offline patch] latestVersion / Plugin Info version check removed.
		// [offline patch] Plugin Info card removed (src/client/components/pluginInfo.tsx).
		...
		function makeContextView(ctx, kit, settings) {
			...
			function ContextViewBody(props) {
				...
				return /* @__PURE__ */ React.createElement("div", {
					...
					locale: activeLocale
				})), /* @__PURE__ */ React.createElement("div", { className: "lc-cols" }, /* @__PURE__ */ React.createElement("div", { className: "lc-col" }, /* @__PURE__ */ React.createElement(CurrentComposition, {
					head,
					subtitle,
					hoverKey: hoverCat,
					onHoverKey: setHoverCat
		...
		*/
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/jump.css.mjs
		...
		const tagId$11 = "dsh-dai-context/jump.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/settings.css.mjs
		...
		const tagId$10 = "dsh-dai-context/settings.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/stackedBar.css.mjs
		...
		const tagId$9 = "dsh-dai-context/stackedBar.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/trendChart.css.mjs
		...
		const tagId$8 = "dsh-dai-context/trendChart.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/requestDetail.css.mjs
		...
		const tagId$7 = "dsh-dai-context/requestDetail.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/events.css.mjs
		...
		const tagId$6 = "dsh-dai-context/events.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/fileCard.css.mjs
		...
		const tagId$5 = "dsh-dai-context/fileCard.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/modal.css.mjs
		...
		const tagId$4 = "dsh-dai-context/modal.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/browser.css.mjs
		...
		const tagId$3 = "dsh-dai-context/browser.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/detailSections.css.mjs
		...
		const tagId$2 = "dsh-dai-context/detailSections.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/attachments.css.mjs
		...
		const tagId$1 = "dsh-dai-context/attachments.css";
		...
		//#endregion
		//#region \0dsh-global-css:/tmp/pack_work_bowenliang123_dsh-dai-context/src/client/styles/agentGraph.css.mjs
		...
		const tagId = "dsh-dai-context/agentGraph.css";
		...
		/**
		* dsh-dai-context — Client half (installed package bundle entry).
		*
		...
		*/
		...
		function apply(ctx) {
			...
			ctx.inject(["settingsScope"], (raw) => {
				...
				c.effect(() => settings.attach(binder.bind({ namespace: NS })), "dsh-dai-context: settings scope");
