...
<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="dsh-dai-agent-teams 把一个 DeepSeek Harness 会话变成可协作的多智能体团队">
</p>

<p align="center">
  <a href="https://dshfind.com/zh/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://img.shields.io/badge/%E7%94%B1%20dshfind-%E6%8E%A8%E8%8D%90-FFD700?style=flat-square" alt="由 dshfind 推荐"></a>
  <a href="https://dshfind.com/zh/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://dshfind.com/api/badge/dsh-dai-agent-teams?lang=zh" alt="dshfind 评分"></a>
  <a href="https://dshfind.com/zh/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://dshfind.com/api/badge/dsh-dai-agent-teams?metric=downloads&amp;lang=zh" alt="dshfind 下载量"></a>
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/dsh-dai-agent-teams"><img src="https://img.shields.io/npm/v/dsh-dai-agent-teams?style=flat-square&amp;color=5B4CF0" alt="npm 版本"></a>
...
`dsh-dai-agent-teams` 让当前 DeepSeek Harness 会话成为队长：创建可续聊的子 Agent、把目标拆成有依赖的任务，并通过直达消息协调成员工作。
...
查看[最新版本说明](https://github.com/dsh-dai-agent-teams/releases/latest)，或浏览[完整发布历史](https://github.com/dsh-dai-agent-teams/releases)。同一份 Markdown 说明也会随 npm 包发布到 `release-notes/` 目录。
