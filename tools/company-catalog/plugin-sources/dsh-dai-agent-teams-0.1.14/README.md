...
<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="dsh-dai-agent-teams turns one DeepSeek Harness session into a coordinated multi-agent team">
</p>

<p align="center">
  <a href="https://dshfind.com/en/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://img.shields.io/badge/recommended%20by-dshfind-FFD700?style=flat-square" alt="Recommended by dshfind"></a>
  <a href="https://dshfind.com/en/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://dshfind.com/api/badge/dsh-dai-agent-teams?lang=en" alt="dshfind score"></a>
  <a href="https://dshfind.com/en/plugins/dsh-dai-agent-teams?ref=badge"><img src="https://dshfind.com/api/badge/dsh-dai-agent-teams?metric=downloads&amp;lang=en" alt="dshfind downloads"></a>
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/dsh-dai-agent-teams"><img src="https://img.shields.io/npm/v/dsh-dai-agent-teams?style=flat-square&amp;color=5B4CF0" alt="npm version"></a>
...
`dsh-dai-agent-teams` turns the current DeepSeek Harness session into a captain that can assemble durable sub-agents, split a goal into dependency-aware tasks, and coordinate work through direct messages.
...
Read the [latest release notes](https://github.com/dsh-dai-agent-teams/releases/latest) or browse the [complete release history](https://github.com/dsh-dai-agent-teams/releases). The same Markdown notes are included in the npm package under `release-notes/`.
...
```sh
dsh plugin --profile web add dsh-dai-agent-teams@latest
```

### Build from source

```sh
git clone https://github.com/dsh-dai-agent-teams.git
cd dsh-dai-agent-teams
pnpm install
pnpm build
...
```sh
npx skills add dsh-dai-agent-teams --skill dsh-plugin-development
```
