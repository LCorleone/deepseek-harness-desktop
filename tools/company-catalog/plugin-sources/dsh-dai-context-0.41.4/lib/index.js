...
*   dsh-file-claim, that applied before dsh-dai-context) with the
...
* @param ctx - the context the dsh-dai-context plugin runs in; its fiber name is
...
/**
* dsh-dai-context host configuration — the `config:` block of the `dsh-dai-context`
...
const SETTINGS_NAMESPACE = "dsh-dai-context";
...
* serving snapshots over a custom `/dsh-dai-context` RPC channel, the plugin
