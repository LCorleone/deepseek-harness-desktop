...
import type { ListEntriesResult, ReadResourceResult, RunScriptResult, ScriptExecutor, ScriptExecutorLimits } from './execute.js';
 ...
 */
export declare function maximumDeadlineMs(limits: ScriptExecutorLimits): number;
/**
