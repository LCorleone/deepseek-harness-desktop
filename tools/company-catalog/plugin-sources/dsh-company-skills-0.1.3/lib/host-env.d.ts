 ...
 */
export declare const COMPANY_SKILLS_EXECUTION_ENVIRONMENT_SLOT: unique symbol;
/**
 ...
 */
export declare function companySkillsExecutionEnvironment(): Readonly<Record<string, string>> | undefined;
