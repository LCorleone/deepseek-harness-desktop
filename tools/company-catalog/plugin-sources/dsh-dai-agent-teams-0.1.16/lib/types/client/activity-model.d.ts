...
/** The floater-wide lifecycle phase across the visible teams for this session. */
export type PanelPhase = 'idle' | 'planning' | 'running' | 'completed' | 'failed' | 'halted';
export interface PanelPhaseTeam {
 ...
 */
export declare function panelPhaseOf(live: readonly PanelPhaseTeam[], archived?: readonly PanelPhaseTeam[]): PanelPhase;
/** Whether the floater shows its animated water-wave surface (any real state). */
export declare function panelRunsWater(phase: PanelPhase): boolean;
