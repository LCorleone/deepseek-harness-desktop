...
[v0.1.16](./release-notes/v0.1.16.md) 是首个稳定版本，已发布到 npm `latest`，修复 Harness RC / Alpha 的启动、成员消息与任务协作兼容问题。安装版本见下方配对表。
...
**推荐组合：DeepSeek Harness `0.1.2-rc.1` + AgentTeams `0.1.16`。Harness 仍是预发布版本，插件为正式版本。**

| 使用场景 | DeepSeek Harness | AgentTeams 插件 |
| --- | --- | --- |
| **推荐安装** | **`0.1.2-rc.1`** | **`0.1.16`** |
| 开发者测试 Alpha | `0.1.2-alpha.5` | `0.1.16` |
| 保留旧 Alpha | `0.1.2-alpha.2` | `0.1.16` |
...
插件正式版 `0.1.16` 已发布到 `latest`；`0.1.15` 面向 Alpha.2。请使用上面的精确版本命令。
