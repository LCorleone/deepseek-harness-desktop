...
This is the first stable release of AgentTeams on npm `latest`. It restores team execution across the exact Harness targets `0.1.2-rc.1`, `0.1.2-alpha.5`, and `0.1.2-alpha.2`, and passes the full Ubuntu and Windows verification matrix. Install the exact plugin version with `dsh plugin --profile web add --save-exact dsh-dai-mobius@0.1.16` after checking that the running host is one of those targets. Older Desktop cores require their own compatible pair.
