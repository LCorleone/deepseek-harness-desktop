...
1. **Ingest and review (收编).** Security-review the source, strip bypass
   ...
   `plugin-sources/dsh-free-search-0.4.182/README-hardened.zh.md` for the
